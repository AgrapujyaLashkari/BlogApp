...
function Header({ handleSearch, handleCategorySelect, selectedCategory, setSearchTerm }) {
        ...
        {isAuthenticated ? (
          <>
            ...
            <main className="container mx-auto px-4 py-8 flex-grow">
              <Routes>
                <Route path="/" element={<Home searchTerm={searchTerm} selectedCategory={selectedCategory} setSearchTerm={setSearchTerm} />} />
